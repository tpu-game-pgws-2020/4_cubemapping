        ...
        SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                //fixed4 diffuse = texCUBE(_EnvDiffuse, normalize(i.worldPos.zxy));
                ...
                col = (1.0 - F) * (1 - metalness) * col * ao * diffuse_light + metalness * F * env;
